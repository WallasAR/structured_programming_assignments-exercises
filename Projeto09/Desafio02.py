# Desafio: Testando seu programa 
# Execute seu programa e tente adicionar uma palavra que já existe no dicionário. O que acontece? 
# O que acontece quando você tenta remover algo que não está no dicionário? 
# Você pode melhorar seu programa para que: 
